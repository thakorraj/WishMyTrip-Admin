...
<div id="page-content-wrapper">
      <div class="container-fluid">
        ...
        <td colspan="4" align="right"><button class="btn btn-primary" ><a href="listusers.php">Home</a></button></td>
      </tr>  
<fieldset>
    <div id="legend">
    ...
    <tr>
     ...
     <td>   <input type="date" id="username" name="username" placeholder="" class="input-xlarge"></td>
        <!--     -->
      <p></p>
</tr>
    </div>
    ...
    <tr>
     ...
     <td>   <input type="radio" id="username" name="gender" placeholder="" class="input-xlarge">Male&nbsp&nbsp<input type="radio" id="username" name="gender" placeholder="" class="input-xlarge">Female</td>
        <!--     -->
      <p></p>
</tr>
    </div>
    ...
    <tr>
     ...
     <td>   <input type="text" id="username" name="contact" placeholder="Enter Contact Details" class="input-xlarge"></td>
        <!--     -->
      <p></p>
</tr>
    </div>
