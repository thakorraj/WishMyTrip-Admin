...
<div id="page-content-wrapper">
      <div class="container-fluid">
        ...
        <td colspan="4" align="right"><button class="btn btn-primary" ><a href="listhotels.php">Home</a></button></td>
      </tr>  
<fieldset>
    <div id="legend">
    ...
    <tr>
      <!-- Username --><td align="right">
      <label class="control-label"  for="username">Feedback</label></td>
      
     <td>   <input type="text" id="username" name="username" placeholder="Enter Feedback" class="input-xlarge"></td>
        <!--     -->
      <p></p>
</tr>
    </div>
    ...
    <tr>
     ...
     <td>   <input type="email" id="username" name="username" placeholder="Enter Ratings" class="input-xlarge"></td>
        <!--     -->
      <p></p>
</tr>
    </div>
    ...
    <tr>
     ...
     <td>   <input type="text" id="username" name="username" placeholder="Enter Description" class="input-xlarge"></td>
        <!--     -->
      <p></p>
</tr>
    </div>
